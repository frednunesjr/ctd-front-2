...
/**
 *  Abaixo o código observa o evento mouseleave no elemento document
 * 
 *  O mouseleave é disparado sempre que o cursor sai do elemento
 *  no nosso caso o elemento document
 *  Fonte: https://developer.mozilla.org/en-US/docs/Web/API/Element/mouseleave_event
 * 
 * */ 
 
document.addEventListener('mouseleave', function(event){
		alert('Não vá embora, temos estes cupons especiais pra você');
});
}